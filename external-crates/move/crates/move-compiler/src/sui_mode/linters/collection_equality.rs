...
//! This analysis flags situations when instances of a one::table::Table or one::table_vec::TableVec
//! or one::bag::Bag are being compared for (in)equality at this type of comparison is not very
