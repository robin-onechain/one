...
{@inject: crates/sui-framework/packages/one-framework/sources/clock.move#fun=timestamp_ms noComments}
...
{@inject: crates/sui-framework/packages/one-framework/sources/clock.move#fun=create_for_testing,share_for_testing,increment_for_testing,set_for_testing,destroy_for_testing noComments}

The next example presents a basic test that creates a Clock, increments it, and then checks its value:

{@inject: crates/sui-framework/packages/one-framework/tests/clock_tests.move#module=one::clock_tests noComments}
...
{@inject: crates/sui-framework/packages/one-framework/sources/tx_context.move#fun=epoch_timestamp_ms noComments}
...
{@inject: crates/sui-framework/packages/one-framework/sources/test/test_scenario.move#fun=later_epoch noComments}
