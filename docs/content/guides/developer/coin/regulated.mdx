...
| `SUI_FULLNODE_URL` | The URL to the Full node network that will process transactions. For Testnet this value is `https://rpc-testnet.onelabs.cc:443`. |
...
{@inject: crates/sui-framework/packages/one-framework/sources/coin.move#fun=mint}
</details>
<details>
<summary>
  `coin::mint_balance<T>`
</summary>
{@inject: crates/sui-framework/packages/one-framework/sources/coin.move#fun=mint_balance}
</details>
<details>
<summary>
  `coin::mint_and_transfer<T>`
</summary>
{@inject: crates/sui-framework/packages/one-framework/sources/coin.move#fun=mint_and_transfer}
</details>
<details>
<summary>
  `coin::burn<T>`
</summary>
{@inject: crates/sui-framework/packages/one-framework/sources/coin.move#fun=burn}
</details>
