...
```sh
$ cargo install --locked --git "https://github.com/one-chain-labs/onechain.git" sui sui-bridge-cli
```
Install with a commit sha:
```sh
$ cargo install --locked --git "https://github.com/one-chain-labs/onechain.git" --rev {SHA} sui sui-bridge-cli
```
...
- Use `cargo install`.
    ```sh
    $ cargo install --locked --git "https://github.com/one-chain-labs/onechain.git" --branch {BRANCH-NAME} sui-bridge
    ```
    Or
    ```sh
    $ cargo install --locked --git "https://github.com/one-chain-labs/onechain.git" --rev {SHA-NAME} sui-bridge
    ```
