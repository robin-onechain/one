...
<table class="w-100">
	...
	<tbody>
		...
		<tr>
			<td class="w-2/3">
				`sui client pay-oct \`<br/>&nbsp;&nbsp;`--input-coins COIN_ID \`<br/>&nbsp;&nbsp;`--recipients ADDRESS \`<br/>&nbsp;&nbsp;`--amounts 100000000`
			</td>
			<td class="w-1/3">Transfer 0.1 SUI to an address and use the same coin for gas</td>
		</tr>
		<tr>
			<td class="w-2/3">`sui client transfer-oct \`<br/>&nbsp;&nbsp;`--sui-coin-object-id COIN_ID \`<br/>&nbsp;&nbsp;`--to ADDRESS`</td>
...
<table class="w-100">
	...
	<tbody>
		...
		<tr>
			<td class="w-2/3">
				`sui client ptb \`<br/>&nbsp;&nbsp;`--move-call one::tx_context::sender \`<br/>&nbsp;&nbsp;`--assign sender \`<br/>&nbsp;&nbsp;`--publish "." \`<br/>&nbsp;&nbsp;`--assign
