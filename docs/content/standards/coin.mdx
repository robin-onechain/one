...
{@inject: crates/sui-framework/packages/one-framework/sources/coin.move#fun=mint noComments}
...
{@inject: crates/sui-framework/packages/one-framework/sources/coin.move#fun=burn noComments}
...
{@inject: crates/sui-framework/packages/one-framework/sources/coin.move#fun=deny_list_v2_add noComments}
...
{@inject: crates/sui-framework/packages/one-framework/sources/coin.move#fun=deny_list_v2_remove noComments}
...
{@inject: crates/sui-framework/packages/one-framework/sources/coin.move#fun=deny_list_v2_enable_global_pause noComments}
...
{@inject: crates/sui-framework/packages/one-framework/sources/coin.move#fun=deny_list_v2_disable_global_pause noComments}
