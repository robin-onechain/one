...
<dt>
<code><b>for</b>: <a href="../sui/object.md#sui_object_ID">one::object::ID</a></code>
</dt>
<dd>
</dd>
</dl>
...
<dt>
<code><a href="../sui/token.md#sui_token_spent_balance">spent_balance</a>: <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;</code>
</dt>
<dd>
...
<dt>
<code><a href="../sui/token.md#sui_token_rules">rules</a>: <a href="../sui/vec_map.md#sui_vec_map_VecMap">one::vec_map::VecMap</a>&lt;<a href="../std/string.md#std_string_String">std::string::String</a>, <a href="../sui/vec_set.md#sui_vec_set_VecSet">one::vec_set::VecSet</a>&lt;<a href="../std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>&gt;&gt;</code>
</dt>
<dd>
...
<dt>
<code><a href="../sui/token.md#sui_token_spent_balance">spent_balance</a>: <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;<a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;&gt;</code>
</dt>
<dd>
...
<dt>
<code><a href="../sui/token.md#sui_token_approvals">approvals</a>: <a href="../sui/vec_set.md#sui_vec_set_VecSet">one::vec_set::VecSet</a>&lt;<a href="../std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_new_policy">new_policy</a>&lt;T&gt;(_treasury_cap: &<a href="../sui/coin.md#sui_coin_TreasuryCap">one::coin::TreasuryCap</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): (<a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;, <a href="../sui/token.md#sui_token_TokenPolicyCap">one::token::TokenPolicyCap</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_share_policy">share_policy</a>&lt;T&gt;(policy: <a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/transfer.md#sui_transfer">transfer</a>&lt;T&gt;(t: <a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;, <a href="../sui/token.md#sui_token_recipient">recipient</a>: <b>address</b>, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): <a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_spend">spend</a>&lt;T&gt;(t: <a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): <a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_to_coin">to_coin</a>&lt;T&gt;(t: <a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): (<a href="../sui/coin.md#sui_coin_Coin">one::coin::Coin</a>&lt;T&gt;, <a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_from_coin">from_coin</a>&lt;T&gt;(<a href="../sui/coin.md#sui_coin">coin</a>: <a href="../sui/coin.md#sui_coin_Coin">one::coin::Coin</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): (<a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;, <a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_join">join</a>&lt;T&gt;(<a href="../sui/token.md#sui_token">token</a>: &<b>mut</b> <a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;, another: <a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_split">split</a>&lt;T&gt;(<a href="../sui/token.md#sui_token">token</a>: &<b>mut</b> <a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;, <a href="../sui/token.md#sui_token_amount">amount</a>: u64, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): <a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_zero">zero</a>&lt;T&gt;(ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): <a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_destroy_zero">destroy_zero</a>&lt;T&gt;(<a href="../sui/token.md#sui_token">token</a>: <a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_keep">keep</a>&lt;T&gt;(<a href="../sui/token.md#sui_token">token</a>: <a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_confirm_request">confirm_request</a>&lt;T&gt;(policy: &<a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;, request: <a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;, _ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): (<a href="../std/string.md#std_string_String">std::string::String</a>, u64, <b>address</b>, <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;<b>address</b>&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_confirm_request_mut">confirm_request_mut</a>&lt;T&gt;(policy: &<b>mut</b> <a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;, request: <a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): (<a href="../std/string.md#std_string_String">std::string::String</a>, u64, <b>address</b>, <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;<b>address</b>&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_confirm_with_treasury_cap">confirm_with_treasury_cap</a>&lt;T&gt;(treasury_cap: &<b>mut</b> <a href="../sui/coin.md#sui_coin_TreasuryCap">one::coin::TreasuryCap</a>&lt;T&gt;, request: <a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;, _ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): (<a href="../std/string.md#std_string_String">std::string::String</a>, u64, <b>address</b>, <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;<b>address</b>&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_add_approval">add_approval</a>&lt;T, W: drop&gt;(_t: W, request: &<b>mut</b> <a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;, _ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_add_rule_config">add_rule_config</a>&lt;T, Rule: drop, Config: store&gt;(_rule: Rule, self: &<b>mut</b> <a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;, cap: &<a href="../sui/token.md#sui_token_TokenPolicyCap">one::token::TokenPolicyCap</a>&lt;T&gt;, <a href="../sui/config.md#sui_config">config</a>: Config, _ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_rule_config">rule_config</a>&lt;T, Rule: drop, Config: store&gt;(_rule: Rule, self: &<a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;): &Config
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_rule_config_mut">rule_config_mut</a>&lt;T, Rule: drop, Config: store&gt;(_rule: Rule, self: &<b>mut</b> <a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;, cap: &<a href="../sui/token.md#sui_token_TokenPolicyCap">one::token::TokenPolicyCap</a>&lt;T&gt;): &<b>mut</b> Config
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_remove_rule_config">remove_rule_config</a>&lt;T, Rule, Config: store&gt;(self: &<b>mut</b> <a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;, cap: &<a href="../sui/token.md#sui_token_TokenPolicyCap">one::token::TokenPolicyCap</a>&lt;T&gt;, _ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): Config
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_has_rule_config">has_rule_config</a>&lt;T, Rule&gt;(self: &<a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_has_rule_config_with_type">has_rule_config_with_type</a>&lt;T, Rule, Config: store&gt;(self: &<a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_allow">allow</a>&lt;T&gt;(self: &<b>mut</b> <a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;, cap: &<a href="../sui/token.md#sui_token_TokenPolicyCap">one::token::TokenPolicyCap</a>&lt;T&gt;, <a href="../sui/token.md#sui_token_action">action</a>: <a href="../std/string.md#std_string_String">std::string::String</a>, _ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_disallow">disallow</a>&lt;T&gt;(self: &<b>mut</b> <a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;, cap: &<a href="../sui/token.md#sui_token_TokenPolicyCap">one::token::TokenPolicyCap</a>&lt;T&gt;, <a href="../sui/token.md#sui_token_action">action</a>: <a href="../std/string.md#std_string_String">std::string::String</a>, _ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_add_rule_for_action">add_rule_for_action</a>&lt;T, Rule: drop&gt;(self: &<b>mut</b> <a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;, cap: &<a href="../sui/token.md#sui_token_TokenPolicyCap">one::token::TokenPolicyCap</a>&lt;T&gt;, <a href="../sui/token.md#sui_token_action">action</a>: <a href="../std/string.md#std_string_String">std::string::String</a>, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_remove_rule_for_action">remove_rule_for_action</a>&lt;T, Rule: drop&gt;(self: &<b>mut</b> <a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;, cap: &<a href="../sui/token.md#sui_token_TokenPolicyCap">one::token::TokenPolicyCap</a>&lt;T&gt;, <a href="../sui/token.md#sui_token_action">action</a>: <a href="../std/string.md#std_string_String">std::string::String</a>, _ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_mint">mint</a>&lt;T&gt;(cap: &<b>mut</b> <a href="../sui/coin.md#sui_coin_TreasuryCap">one::coin::TreasuryCap</a>&lt;T&gt;, <a href="../sui/token.md#sui_token_amount">amount</a>: u64, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): <a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_burn">burn</a>&lt;T&gt;(cap: &<b>mut</b> <a href="../sui/coin.md#sui_coin_TreasuryCap">one::coin::TreasuryCap</a>&lt;T&gt;, <a href="../sui/token.md#sui_token">token</a>: <a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_flush">flush</a>&lt;T&gt;(self: &<b>mut</b> <a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;, cap: &<b>mut</b> <a href="../sui/coin.md#sui_coin_TreasuryCap">one::coin::TreasuryCap</a>&lt;T&gt;, _ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_is_allowed">is_allowed</a>&lt;T&gt;(self: &<a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;, <a href="../sui/token.md#sui_token_action">action</a>: &<a href="../std/string.md#std_string_String">std::string::String</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_rules">rules</a>&lt;T&gt;(self: &<a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;, <a href="../sui/token.md#sui_token_action">action</a>: &<a href="../std/string.md#std_string_String">std::string::String</a>): <a href="../sui/vec_set.md#sui_vec_set_VecSet">one::vec_set::VecSet</a>&lt;<a href="../std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_spent_balance">spent_balance</a>&lt;T&gt;(self: &<a href="../sui/token.md#sui_token_TokenPolicy">one::token::TokenPolicy</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_value">value</a>&lt;T&gt;(t: &<a href="../sui/token.md#sui_token_Token">one::token::Token</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_action">action</a>&lt;T&gt;(self: &<a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;): <a href="../std/string.md#std_string_String">std::string::String</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_amount">amount</a>&lt;T&gt;(self: &<a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_sender">sender</a>&lt;T&gt;(self: &<a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;): <b>address</b>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_recipient">recipient</a>&lt;T&gt;(self: &<a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;): <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;<b>address</b>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_approvals">approvals</a>&lt;T&gt;(self: &<a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;): <a href="../sui/vec_set.md#sui_vec_set_VecSet">one::vec_set::VecSet</a>&lt;<a href="../std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/token.md#sui_token_spent">spent</a>&lt;T&gt;(self: &<a href="../sui/token.md#sui_token_ActionRequest">one::token::ActionRequest</a>&lt;T&gt;): <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;u64&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="../sui/token.md#sui_token_key">key</a>&lt;Rule&gt;(): <a href="../sui/token.md#sui_token_RuleKey">one::token::RuleKey</a>&lt;Rule&gt;
</code></pre>
