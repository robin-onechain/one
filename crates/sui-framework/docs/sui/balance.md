...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/balance.md#sui_balance_value">value</a>&lt;T&gt;(self: &<a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/balance.md#sui_balance_supply_value">supply_value</a>&lt;T&gt;(supply: &<a href="../sui/balance.md#sui_balance_Supply">one::balance::Supply</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/balance.md#sui_balance_create_supply">create_supply</a>&lt;T: drop&gt;(_: T): <a href="../sui/balance.md#sui_balance_Supply">one::balance::Supply</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/balance.md#sui_balance_increase_supply">increase_supply</a>&lt;T&gt;(self: &<b>mut</b> <a href="../sui/balance.md#sui_balance_Supply">one::balance::Supply</a>&lt;T&gt;, <a href="../sui/balance.md#sui_balance_value">value</a>: u64): <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/balance.md#sui_balance_decrease_supply">decrease_supply</a>&lt;T&gt;(self: &<b>mut</b> <a href="../sui/balance.md#sui_balance_Supply">one::balance::Supply</a>&lt;T&gt;, <a href="../sui/balance.md#sui_balance">balance</a>: <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/balance.md#sui_balance_zero">zero</a>&lt;T&gt;(): <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/balance.md#sui_balance_join">join</a>&lt;T&gt;(self: &<b>mut</b> <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;, <a href="../sui/balance.md#sui_balance">balance</a>: <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/balance.md#sui_balance_split">split</a>&lt;T&gt;(self: &<b>mut</b> <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;, <a href="../sui/balance.md#sui_balance_value">value</a>: u64): <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/balance.md#sui_balance_withdraw_all">withdraw_all</a>&lt;T&gt;(self: &<b>mut</b> <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;): <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/balance.md#sui_balance_destroy_zero">destroy_zero</a>&lt;T&gt;(<a href="../sui/balance.md#sui_balance">balance</a>: <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="../sui/balance.md#sui_balance_create_staking_rewards">create_staking_rewards</a>&lt;T&gt;(<a href="../sui/balance.md#sui_balance_value">value</a>: u64, ctx: &<a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="../sui/balance.md#sui_balance_destroy_storage_rebates">destroy_storage_rebates</a>&lt;T&gt;(self: <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;, ctx: &<a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<a href="../sui/package.md#sui_package">package</a>) <b>fun</b> <a href="../sui/balance.md#sui_balance_destroy_supply">destroy_supply</a>&lt;T&gt;(self: <a href="../sui/balance.md#sui_balance_Supply">one::balance::Supply</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="../sui/balance.md#sui_balance_send_to_account">send_to_account</a>&lt;T&gt;(<a href="../sui/balance.md#sui_balance">balance</a>: <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;, recipient: <b>address</b>)
</code></pre>
...
<pre><code><b>fun</b> <a href="../sui/balance.md#sui_balance_send_to_account">send_to_account</a>&lt;T&gt;(<a href="../sui/balance.md#sui_balance">balance</a>: <a href="../sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;, recipient: <b>address</b>) {
    <b>let</b> <a href="../sui/balance.md#sui_balance_Balance">Balance</a> { <a href="../sui/balance.md#sui_balance_value">value</a> } = <a href="../sui/balance.md#sui_balance">balance</a>;
    <b>let</b> <a href="../sui/accumulator.md#sui_accumulator">accumulator</a> = <a href="../sui/accumulator.md#sui_accumulator_accumulator_address">one::accumulator::accumulator_address</a>&lt;<a href="../sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;&gt;(recipient);
    <a href="../sui/accumulator.md#sui_accumulator_emit_deposit_event">one::accumulator::emit_deposit_event</a>&lt;<a href="../sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;&gt;(<a href="../sui/accumulator.md#sui_accumulator">accumulator</a>, recipient, <a href="../sui/balance.md#sui_balance_value">value</a>);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="../sui/balance.md#sui_balance_withdraw_from_account">withdraw_from_account</a>&lt;T&gt;(amount: u64, ctx: &<a href="../sui/tx_context.md#sui_tx_context_TxContext">one::tx_context::TxContext</a>): <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="../sui/balance.md#sui_balance_withdraw_from_account">withdraw_from_account</a>&lt;T&gt;(amount: u64, ctx: &TxContext): <a href="../sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt; {
    ...
    <b>let</b> <a href="../sui/accumulator.md#sui_accumulator">accumulator</a> = <a href="../sui/accumulator.md#sui_accumulator_accumulator_address">one::accumulator::accumulator_address</a>&lt;<a href="../sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;&gt;(owner);
    ...
    <a href="../sui/accumulator.md#sui_accumulator_emit_withdraw_event">one::accumulator::emit_withdraw_event</a>&lt;<a href="../sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;&gt;(<a href="../sui/accumulator.md#sui_accumulator">accumulator</a>, owner, amount);
    credit
}
</code></pre>
