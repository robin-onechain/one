...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/bls12381.md#sui_bls12381">bls12381</a>(): <a href="../sui/groth16.md#sui_groth16_Curve">one::groth16::Curve</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/groth16.md#sui_groth16_bn254">bn254</a>(): <a href="../sui/groth16.md#sui_groth16_Curve">one::groth16::Curve</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/groth16.md#sui_groth16_pvk_from_bytes">pvk_from_bytes</a>(vk_gamma_abc_g1_bytes: vector&lt;u8&gt;, alpha_g1_beta_g2_bytes: vector&lt;u8&gt;, gamma_g2_neg_pc_bytes: vector&lt;u8&gt;, delta_g2_neg_pc_bytes: vector&lt;u8&gt;): <a href="../sui/groth16.md#sui_groth16_PreparedVerifyingKey">one::groth16::PreparedVerifyingKey</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/groth16.md#sui_groth16_pvk_to_bytes">pvk_to_bytes</a>(pvk: <a href="../sui/groth16.md#sui_groth16_PreparedVerifyingKey">one::groth16::PreparedVerifyingKey</a>): vector&lt;vector&lt;u8&gt;&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/groth16.md#sui_groth16_public_proof_inputs_from_bytes">public_proof_inputs_from_bytes</a>(bytes: vector&lt;u8&gt;): <a href="../sui/groth16.md#sui_groth16_PublicProofInputs">one::groth16::PublicProofInputs</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/groth16.md#sui_groth16_proof_points_from_bytes">proof_points_from_bytes</a>(bytes: vector&lt;u8&gt;): <a href="../sui/groth16.md#sui_groth16_ProofPoints">one::groth16::ProofPoints</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/groth16.md#sui_groth16_prepare_verifying_key">prepare_verifying_key</a>(curve: &<a href="../sui/groth16.md#sui_groth16_Curve">one::groth16::Curve</a>, verifying_key: &vector&lt;u8&gt;): <a href="../sui/groth16.md#sui_groth16_PreparedVerifyingKey">one::groth16::PreparedVerifyingKey</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="../sui/groth16.md#sui_groth16_prepare_verifying_key_internal">prepare_verifying_key_internal</a>(curve: u8, verifying_key: &vector&lt;u8&gt;): <a href="../sui/groth16.md#sui_groth16_PreparedVerifyingKey">one::groth16::PreparedVerifyingKey</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/groth16.md#sui_groth16_verify_groth16_proof">verify_groth16_proof</a>(curve: &<a href="../sui/groth16.md#sui_groth16_Curve">one::groth16::Curve</a>, prepared_verifying_key: &<a href="../sui/groth16.md#sui_groth16_PreparedVerifyingKey">one::groth16::PreparedVerifyingKey</a>, public_proof_inputs: &<a href="../sui/groth16.md#sui_groth16_PublicProofInputs">one::groth16::PublicProofInputs</a>, proof_points: &<a href="../sui/groth16.md#sui_groth16_ProofPoints">one::groth16::ProofPoints</a>): bool
</code></pre>
