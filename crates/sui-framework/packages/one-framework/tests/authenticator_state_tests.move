...
fun authenticator_state_tests_basic() {
    ...
    let jwk1 = create_active_jwk(
        b"iss1".to_string(),
        b"key1".to_string(),
        b"key1_payload".to_string(),
        1,
    );
    let jwk2 = create_active_jwk(
        b"iss1".to_string(),
        b"key2".to_string(),
        b"key2_payload".to_string(),
        1,
    );
    let jwk3 = create_active_jwk(
        b"iss1".to_string(),
        b"key3".to_string(),
        b"key3_payload".to_string(),
        1,
    );
...
fun authenticator_state_tests_deduplication() {
    ...
    let jwk1 = create_active_jwk(
        b"https://accounts.google.com".to_string(),
        b"kid2".to_string(),
        b"k1".to_string(),
        0,
    );
    ...
    let jwk2 = create_active_jwk(
        b"https://www.facebook.com".to_string(),
        b"kid1".to_string(),
        b"k2".to_string(),
        0,
    );
...
fun authenticator_state_tests_expiry_edge_cases() {
    ...
    let jwk5 = create_active_jwk(
        b"iss2".to_string(),
        b"key5".to_string(),
        b"key5_payload".to_string(),
        3,
    );
    let jwk6 = create_active_jwk(
        b"iss3".to_string(),
        b"key6".to_string(),
        b"key6_payload".to_string(),
        3,
    );
    auth_state.update_authenticator_state_for_testing(
        vector[jwk5, jwk6],
