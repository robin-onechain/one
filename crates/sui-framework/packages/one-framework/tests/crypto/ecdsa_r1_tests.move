...
fun test_ecrecover_pubkey() {
    ...
    let sig =
        x"209841acabd0fdf6d25fa0948b2f5c6c74f930eede89c6fce59502218a3134a147535921bf0cdf5d1990f6f0b3dadb8c05069ddc531db057d325857ce198a52900";
    ...
    // recover with Sha256
    let sig =
        x"26d84720652d8bc4ddd1986434a10b3b7b69f0e35a17c6a5987e6d1cba69652f4384a342487642df5e44592d304bea0ceb0fae2e347fa3cec5ce1a8144cfbbb200";
...
fun test_ecrecover_pubkey_invalid_sig() {
    let msg = b"Hello, world!";
    let sig =
        x"26d84720652d8bc4ddd1986434a10b3b7b69f0e35a17c6a5987e6d1cba69652f4384a342487642df5e44592d304bea0ceb0fae2e347fa3cec5ce1a8144cfbbb2";
...
fun test_secp256r1_verify_fails_with_recoverable_sig() {
    ...
    let sig =
        x"209841acabd0fdf6d25fa0948b2f5c6c74f930eede89c6fce59502218a3134a147535921bf0cdf5d1990f6f0b3dadb8c05069ddc531db057d325857ce198a52901";
    let verify = ecdsa_r1::secp256r1_verify(&sig, &pk, &msg, 0);
    assert!(verify == false);
}
...
fun test_secp256r1_verify_success_with_nonrecoverable_sig() {
    ...
    let sig =
        x"209841acabd0fdf6d25fa0948b2f5c6c74f930eede89c6fce59502218a3134a147535921bf0cdf5d1990f6f0b3dadb8c05069ddc531db057d325857ce198a529";
    let verify = ecdsa_r1::secp256r1_verify(&sig, &pk, &msg, 0);
    assert!(verify == true);
