...
#[test, expected_failure(abort_code = one_system::validator::EMetadataInvalidPubkey)]
...
#[test, expected_failure(abort_code = one_system::validator::EMetadataInvalidNetPubkey)]
...
#[test, expected_failure(abort_code = one_system::validator::EMetadataInvalidWorkerPubkey)]
...
#[test, expected_failure(abort_code = one_system::validator::EMetadataInvalidNetAddr)]
...
#[test, expected_failure(abort_code = one_system::validator::EMetadataInvalidP2pAddr)]
...
#[test, expected_failure(abort_code = one_system::validator::EMetadataInvalidPrimaryAddr)]
...
#[test, expected_failure(abort_code = one_system::validator::EMetadataInvalidWorkerAddr)]
...
#[test, expected_failure(abort_code = one_system::validator::EInvalidProofOfPossession)]
...
#[
    test,
    expected_failure(
        abort_code = one_system::validator::EValidatorMetadataExceedingLengthLimit,
    ),
]
