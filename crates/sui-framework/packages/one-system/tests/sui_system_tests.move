...
#[test, expected_failure(abort_code = ::one_system::validator_set::EInvalidCap)]
...
#[test, expected_failure(abort_code = one_system::validator::EGasPriceHigherThanThreshold)]
...
#[test, expected_failure(abort_code = one_system::validator::ECommissionRateTooHigh)]
...
#[test, expected_failure(abort_code = one_system::sui_system_state_inner::ENotValidator)]
...
#[test, expected_failure(abort_code = one_system::sui_system_state_inner::EReportRecordNotFound)]
...
#[test, expected_failure(abort_code = one_system::sui_system_state_inner::ECannotReportOneself)]
