...
//> 0: one::table::new<u64, one::coin::Coin<one::oct::OCT>>();
...
//> 0: one::table::add<u64, one::coin::Coin<one::oct::OCT>>(Input(0), Input(1), Input(2));
...
//> 0: one::table::remove<u64, one::coin::Coin<one::oct::OCT>>(Input(0), Input(1));
