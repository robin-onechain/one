...
pub const SUI_KEYSTORE_FILENAME: &str = "one.keystore";
pub const SUI_KEYSTORE_ALIASES_FILENAME: &str = "one.aliases";
...
pub const SUI_DEV_NET_URL: &str = "https://rpc-devnet.onelabs.cc:443";
